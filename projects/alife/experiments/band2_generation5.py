#!/usr/bin/env python3
"""
Band 2 generation 5 — Band 3 threshold lowered to 1.90 (quality-weighted score).

Same mechanics as gen 4 except Band 3 gate.
...
def main() -> int:
    ...
    out_path = REPORT_DIR / f"band2_generation5_{stamp}.json"
