#!/usr/bin/env python3
"""
Band 2 generation 3 — same parameters as gen 2 plus cooperation quality metrics.

Tracks mutual benefit vs false cooperation, trust stability, net resource from cooperation.
...
def main() -> int:
    ...
    out_path = REPORT_DIR / f"band2_generation3_{stamp}.json"
