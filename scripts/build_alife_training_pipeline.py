...
class ALIFETrainingDataBuilder:
    ...
    def __init__(self, chroma_host: str = "servicebox.taileb8c60.ts.net", chroma_port: int = 8000):
...
def main():
    ...
    parser.add_argument("--chroma-host", default="servicebox.taileb8c60.ts.net", help="ChromaDB host")
