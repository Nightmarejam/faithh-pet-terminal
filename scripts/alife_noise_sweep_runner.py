#!/usr/bin/env python3
"""Run Band 2 generation 6 noise sweeps and build a combined aggregate report."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run generation-6 noise sweep and aggregate.")
    parser.add_argument(
        "--levels",
    ...
    parser.add_argument(
        "--output",
        default="reports/alife/band2_gen6_noise_sweep_aggregate.json",
    ...
    exp_script = repo_root / "projects/alife/experiments/band2_generation6_noise_sweep.py"
    ...
    for amp in levels:
        ...
        out = f"reports/alife/band2_generation6_n{tag}_aggregate.json"
        run_cmd(
            [
                sys.executable,
                str(agg_script),
                ...
                "6",
                "--pattern",
                f"reports/alife/band2_generation6_n{tag}_*.json",
                "--output",
                out,
            ],
            cwd=repo_root,
