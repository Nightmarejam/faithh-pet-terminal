#!/usr/bin/env python3
"""Run Band 2 generation 8 calibrated-vs-biased and build a combined aggregate report."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run generation-8 calibrated-vs-biased sweep and aggregate.")
    parser.add_argument(
        "--levels",
        default="0.4",
    ...
    parser.add_argument(
        "--output",
        default="reports/alife/band2_gen8_bias_aggregate.json",
    ...
    exp_script = repo_root / "projects/alife/experiments/band2_generation8_bias_test.py"
    ...
    for amp in levels:
        ...
        out = f"reports/alife/band2_generation8_n{tag}_aggregate.json"
        run_cmd(
            [
                sys.executable,
                str(agg_script),
                ...
                "8",
                "--pattern",
                f"reports/alife/band2_generation8_n{tag}_*.json",
                "--output",
                out,
            ],
            cwd=repo_root,
