...
MODEL_ROUTING = {
    ...
    'llama31-faithh:latest': 'ollama',
    'qwen3-faithh:latest': 'ollama',
    'gemini': 'unified',
...
def list_models():
    ...
    models = {
        'models': [
            ...
            {'name': 'llama31-faithh:latest', 'title': '💬 Llama31 Faithh (8B)'},
            {'name': 'qwen3-faithh:latest', 'title': '💻 Qwen3 Faithh (30.5B)'},
