# Archived: Export Duplicates
**Archived:** 2026-01-07 17:24:29
...
cp ARCHIVE/2026-01-07_dedupe/export_duplicates/<filename> ./<original_path>

# Or use git to restore and preserve history
git mv ARCHIVE/2026-01-07_dedupe/export_duplicates/<filename> ./<original_path>
```
