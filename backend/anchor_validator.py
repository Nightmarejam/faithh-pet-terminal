...
class AnchorValidator:
    ...
    def validate_faithh_phase(self, ml_chips=None, ml_chip_centroids=None) -> Dict[str, Any]:
        ...
        try:
            ...
            count_endpoints = [
                'http://100.79.85.32:8000/api/v1/collections/faithh_knowledge_base/count',
                'http://100.79.85.32:8000/api/v2/collections/faithh_knowledge_base/count'
            ]
            ...
            if doc_count is not None:
                ...
                heartbeat_response = requests.get('http://100.79.85.32:8000/api/v2/heartbeat', timeout=3)
