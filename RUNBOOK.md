...
**Gen8 vs faithh:** [docs/ops/GEN8_START.md](docs/ops/GEN8_START.md) · **Audits:** [docs/ops/MULTI_HOST_AUDIT.md](docs/ops/MULTI_HOST_AUDIT.md) · **Git:** [docs/ops/GIT_DIVERGENCE.md](docs/ops/GIT_DIVERGENCE.md) · **Parent repo vs terminal copy:** [docs/ops/REPO_PARENT_JONAT_FAITHH.md](docs/ops/REPO_PARENT_JONAT_FAITHH.md)
