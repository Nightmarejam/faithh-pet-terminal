...
# Backend
~/ai-stack/faithh_professional_backend_fixed.py   # Main backend (shim: faithh_professional_backend.py)
...
# Full git rollback:
git checkout HEAD -- faithh_professional_backend_fixed.py
git status
```
...
# Restart
pkill -f faithh_professional_backend
cd ~/ai-stack && python faithh_professional_backend_fixed.py
```
