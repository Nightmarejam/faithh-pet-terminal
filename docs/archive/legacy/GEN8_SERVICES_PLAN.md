...
**Purpose:** Home services box for Pi-hole DNS filtering, ChromaDB, and monitoring

---

## 🎯 Project Overview

The HP ProLiant MicroServer Gen8 is now operational as a dedicated home services box, handling DNS-level ad blocking, ChromaDB database, and service monitoring without impacting the primary infrastructure.
...
- **Status:** ✅ ONLINE - Running in production
- **Current Config:** Upgraded with Xeon E3-1265L v2 + 16GB ECC RAM

### Completed Upgrades
| Component | Specification | Status |
|-----------|--------------|--------|
| **CPU** | Intel Xeon E3-1265L v2 | ✅ Installed |
| **RAM** | 2x 8GB DDR3-1600 ECC UDIMM | ✅ Installed (16GB total) |
| **Total Cost** | ~$110-130 | ✅ Paid |
...
- Documents: 27,547 chunks
- Embedding: BGE-base-en-v1.5 (768 dimensions)
- Storage: /data/chromadb

**Data Breakdown:**
- ChatGPT conversations: 18,401 chunks (Oct-Dec 2025)
- Documentation: 6,829 chunks (ai-stack + Constella)
- Claude conversations: 2,264 chunks (Oct-Dec 2025)
- Business docs: 53 chunks (Tom Cat Sound LLC)
