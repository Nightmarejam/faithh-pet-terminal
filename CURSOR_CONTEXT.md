...
|---|---|---|
| FAITHH backend | ✅ Running | http://192.168.1.100:5557 |
| ChromaDB | ✅ Running | servicebox.taileb8c60.ts.net:8000 |
| vLLM | ✅ Running | http://192.168.1.100:8000 |
| Groq | ✅ Configured | llama-3.3-70b-versatile |
| SSH | ✅ Working | ssh faithh (jonat@192.168.1.100) |
...
Access: http://192.168.1.100:5557 (main UI), http://192.168.1.100:5557/faithh_cockpit.html (cockpit)
...
| Host | Role | IP |
|---|---|---|
| faithh VM (Proxmox) | FAITHH backend, vLLM, inference | 192.168.1.100 |
| Gen8 NAS | ChromaDB, Plex, file storage | servicebox.taileb8c60.ts.net |
| Windows (bare metal) | Dev workstation, Windsurf, browser | 192.168.1.101 |
